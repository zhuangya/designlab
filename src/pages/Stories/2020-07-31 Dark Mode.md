...
简单理解下来就是，在过去亮色 UI 下，无论使用的是中性灰还是阴影来塑造的层级，在暗色模式下，均使用提亮的方式进行塑造层级。在工作项目中，要将大量的背景色按照前后层级来归类，对应设计出暗色层级。层级对照表建立好之后，前端开发只需关心当前使用的层级而不是颜色。

### 前景色与背景色的对比度

![](https://dl.airtable.com/.attachments/71ed131d4bf32937696b9269b5fdadf8/eafc91f2/color.png)

前景色分为两种，强调色与文字元素色，我更倾向 Apple 的处理方式，
...
我将网站内所有用到的色彩按照使用场景变量化，前提是要按照前面讲的设计逻辑重新梳理一遍，并且将这些变量进行 DarkMode 适配，这样比每个组件进行 “黑暗化” 就容易得多了，下面是我网站色彩变量 “黑暗化” 的 CSS。
